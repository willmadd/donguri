...
export default function ChatPage() {
  ...
  return (
    <main className="flex min-h-full flex-col items-center gap-10 bg-washi px-4 py-10 lg:flex-row lg:items-start lg:justify-center">
      <div className="flex flex-col items-center gap-3">
        <div className="text-center">
          <h1 className="text-2xl text-sumi">
            {t("chat.title", "Chat with Charles Duck")}
          </h1>
          <p className="text-sm text-sumi-soft">
            {t("chat.try_to_use", "Try to use")}{" "}
              ...
              {isSessionComplete && (
                <div className="flex justify-center pt-2">
                  <p className="rounded-full bg-ai/10 px-3 py-1 text-xs font-medium text-ai">
                    {t("chat.session_complete", "🎉 Session complete! You used every word naturally.")}
                  </p>
                </div>
              )}
            </div>
