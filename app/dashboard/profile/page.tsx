...
export default async function ProfilePage() {
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <div className="flex items-center justify-between gap-4 rounded-2xl border border-sumi/10 bg-washi-soft p-6">
        <div>
          <h2 className="font-semibold text-sumi">Experience points</h2>
          <p className="mt-1 text-sm text-sumi-soft">
            +1 XP per correct quiz answer, +5 for a perfect quiz, and a growing bonus
            for every consecutive day you keep your streak going (+0.5 more each day
            you do a quiz — day 2 is +0.5, day 3 is +1, and so on). Level up to
            upgrade your Donguri character — unlocking new outfits, and more content
            to come.
          </p>
        </div>
